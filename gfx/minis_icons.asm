...
SECTION "Testmon Mini Icon", ROMX
TestmonMini::     INCBIN "gfx/minis/testmon.2bpp.lz"
TestmonMiniMask:: INCBIN "gfx/minis/testmon_mask.1bpp.lz"
TestmonIcon::     INCBIN "gfx/icons/testmon.2bpp.lz"
